package org.aatab.servicetask;
  ...
  @ApplicationScoped
  public class ArOverdueValidationTask {

      private static final Logger LOG = Logger.getLogger(ArOverdueValidationTask.class);
    ...
    GenericTask generictask;
      ...
      public ApiResponse<Order> processOrderValidation(Order order) {
          ...
          try {
              ...
              boolean insertResult = databaseService.updateOrderOverdueValidation(order.getOrderId());
