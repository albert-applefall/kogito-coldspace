...
@ApplicationScoped
  public class AtRiskValidationTask {

      private static final Logger LOG = Logger.getLogger(AtRiskValidationTask.class);
    ...
    GenericTask generictask;
      ...
      public ApiResponse<Order> processOrderValidation(Order order) {
          ...
          try {
              ...
              boolean insertResult = databaseService.updateCustomerAtRiskValidation(order.getOrderId(),order.getCustomerCode());
